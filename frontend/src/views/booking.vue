      ...
      <div class="modal-content">
        ...
        <div class="booking-details">
          ...
          <div class="detail-row">
            ...
            <span class="detail-value">R{{ currentBooking.totalPrice.toFixed(2) }}</span>
          </div>
          <div class="detail-row">
...
onMounted(() => {
  // In a real app, you would fetch bookings and packages from your API here
  // fetchBookings();
  // fetchPackages();
});
...
/* Adding booking-specific styles */
